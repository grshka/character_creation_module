'''Модуль для рандоминизации урона.'''
...
def defence(char_name, char_class):
    '''Функция распределения блокировки урона героя.'''
    if char_class == 'warrior':
...
def special(char_name, char_class):
    '''Функция специальных умений героя в зависимости от их класса.'''
    if char_class == 'warrior':
...
def start_training(char_name, char_class):
    '''Функция выбора имени и класса героя.'''
    if char_class == 'warrior':
